...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-[200] p-4 sm:p-6">
      <div className="max-w-3xl mx-auto bg-surface border border-black/10 rounded-2xl p-5 sm:p-6 shadow-2xl flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            className="bg-accent text-white text-sm font-semibold px-5 py-2 rounded-full hover:brightness-110 transition"
          >
            Accept
          </button>
        </div>
