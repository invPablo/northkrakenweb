  ...
  return (
    <div className="bg-background-dark text-foreground-light min-h-screen font-sans">
      ...
      <section className="px-6 lg:px-20 pt-32 pb-24 max-w-3xl mx-auto">
        ...
        <div className="mt-12 flex flex-col gap-8 text-zinc-600 leading-relaxed [&_h2]:font-display [&_h2]:uppercase [&_h2]:text-xl [&_h2]:text-foreground-light [&_h2]:mt-4 [&_p]:text-base [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:flex [&_ul]:flex-col [&_ul]:gap-2 [&_a]:text-accent [&_a]:underline [&_a:hover]:opacity-80">
          {children}
        </div>
      </section>
